...
//Pada bagian ini telah diselesaikan tahapan untuk pemodelan ViewModel.
// Semua data yang digunakan, interaksi melalui ViewModel ini.

public class SharedScore extends AndroidViewModel {

    //untuk menympan informasi yang dibutuhkan
